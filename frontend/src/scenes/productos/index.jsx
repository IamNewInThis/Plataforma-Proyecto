...
const Productos = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`http://localhost:3001/api/${editedProduct._id}`, {
                    ...
                    <Card key={index} sx={{
                        ...
                        <CardContent>
                            ...
                            <Box display={'flex'} justifyContent={'space-between'}>
                                <Button variant="contained" onClick={() => handleOpen(producto)} color="success">Editar</Button>

                                <Button variant="contained" color='error' onClick={() => handleDelete(producto._id)} sx={{ width: '87.75px' }}>Eliminar</Button>
                            </Box>
                            <Modal
                                open={open}
                                onClose={handleClose}
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid item xs={12} md={6}>
                                                ...
                                                <TextField
                                                    placeholder="nombre"
                                                    label="Nombre"
                                                    value={setEditedProduct.nombre || (editedProduct && editedProduct.nombre) || ''}
                                            ...
                                            <Grid item xs={12} md={6}>
                                                ...
                                                <TextField
                                                    placeholder="precio"
                                                    label="precio"
                                                    value={setEditedProduct.precio || (editedProduct && editedProduct.precio) || ''}
                                            ...
                                            <Grid item xs={12} md={6}>
                                                ...
                                                <TextField
                                                    placeholder="0"
                                                    label="stock"
                                                    value={setEditedProduct.stock || (editedProduct && editedProduct.stock) || ''}
                                            ...
                                            <Grid item xs={12} md={6}>
                                                ...
                                                <TextField placeholder="Categoría"
                                                    label="categoria"
                                                    value={setEditedProduct.categoria || (editedProduct && editedProduct.categoria) || ''}
                                            ...
                                            <Grid item xs={12} md={6} marginBottom={'6rem'}>
                                                ...
                                                <TextField
                                                    ...
                                                    label="subcategoria"
                                                    value={setEditedProduct.subcategoria || (editedProduct && editedProduct.subcategoria) || ''}
                                                    onChange={(e) => setEditedProduct({ ...editedProduct, subcategoria: e.target.value })}
                                                    margin="normal"
                                                    fullWidth />
                                            </Grid>
                                        </Grid>
